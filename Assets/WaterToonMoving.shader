Shader "Alannis/Water"
{
    ...
    SubShader
    {
        ...
        void vert(inout appdata_full v) {
            ...
            displaceCalc.y = _Amp * sin(displaceCalc.x * _v + _m *(_speed * _Time.y)) * _z ;  //gets sine wave calculation and then moves it based on time scaled by the speed
        ...
        void surf (Input IN, inout SurfaceOutput o) {
            ...
            o.Albedo = _Color * c;
            o.Normal = UnpackNormal(tex2D(_RampTex, IN.uv_RampTex));
        }
